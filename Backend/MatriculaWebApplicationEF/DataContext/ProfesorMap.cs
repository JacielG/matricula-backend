...
namespace MatriculaWebApplicationEF.DataContext
{
    public class ProfesorMap : IEntityTypeConfiguration<Profesor>
    {
        public void Configure(EntityTypeBuilder<Profesor> builder)
        {
            ...
            builder.Property(e => e.Telefono).HasColumnType("varchar(50)").HasMaxLength(50).IsRequired();
            builder.Property(e => e.Direccion).HasColumnType("varchar(50)").HasMaxLength(50).IsRequired();
            ...
            builder.Property(e => e.EstaActivo).HasColumnType("varchar(50)");
